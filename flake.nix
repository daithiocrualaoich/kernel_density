{
  ...
  outputs = { self, nixpkgs, rust-overlay, flake-utils, ... }:
    let
      ...
      rust-fn = pkgs: pkgs.rust-bin.fromRustupToolchainFile ./nix/rust-toolchain.toml;
      build-fn = pkgs: pkgs.rustPlatform.buildRustPackage {
      ...
      lint-fn = pkgs: pkgs.stdenv.mkDerivation {
